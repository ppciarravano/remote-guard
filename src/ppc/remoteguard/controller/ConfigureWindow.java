...
/**
 * Classe per creare e gestire la GUI di configurazione dei parametri di connessione del Controller.
 * 
...
{
	private ControllerTray controllerTray;
	...
	static
	{
		...
		validPassword = ConstantManager.SERVER_PASSWORD_CONTROLLER;
	}
		
	public ConfigureWindow(ControllerTray controllerTray)
	{
		this.controllerTray = controllerTray;
		init(controllerTray.getImageIcon());
	}
	...
	private void init(Image image) 
	{
		if(jFrame==null)
		{
			...
			jFrameTemp.setTitle("RemoteGuard (Controller) Connection configuration");
			...
			annullaBtn.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					jFrame.dispose();
					controllerTray.setEnableConnect(true);
				}
			});
			...
			connettiBtn.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (validate())
					{
						jFrame.dispose();
						controllerTray.setEnableConnect(true);
						controllerTray.connect(validHostName, validUdpPortNumber, validPassword);
					}
					else
					{
